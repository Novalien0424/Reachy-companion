...
| `REALTIME_COMMIT_HOLDOFF_MS`       | Client-side wait after an accepted turn before requesting the answer. Default `700`; `0` disables. Skips when the next speech segment starts so fragments can merge. |
