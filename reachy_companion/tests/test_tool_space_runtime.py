...
import reachy_companion.tool_spaces as tool_spaces_mod
...
def _reload_core_tools() -> ModuleType:
    for module_name in list(sys.modules):
        if module_name.startswith("reachy_companion.tools."):
            sys.modules.pop(module_name, None)

    sys.modules.pop("reachy_companion.tools.core_tools", None)
    return importlib.import_module("reachy_companion.tools.core_tools")
