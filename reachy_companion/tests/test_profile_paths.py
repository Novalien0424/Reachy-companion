...
import reachy_companion.personality as headless_mod
import reachy_companion.profile_store as profile_store_mod
from reachy_companion.config import DEFAULT_PROFILES_DIRECTORY, config
from reachy_companion.personality import (
    list_personalities,
)
from reachy_companion.profile_store import read_profile, write_profile, read_profile_from_directory
...
#     \spaces--pollen-robotics--reachy_companion
...
#   back to the budget: 101 + len("reachy_companion\") (29) = 130.
#
...
def test_explicit_default_profile_does_not_fall_back_to_itself(
    ...
    with caplog.at_level(logging.WARNING, logger="reachy_companion.prompts"):
