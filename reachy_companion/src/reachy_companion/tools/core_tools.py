...
from reachy_companion.mcp_client import McpToolTimeoutError, McpToolInvocationError
from reachy_companion.tool_spaces import build_remote_client, read_installed_tool_spaces
from reachy_companion.profile_toolsets import read_profile_tool_names
from reachy_companion.tools.tool_constants import SystemTool


if TYPE_CHECKING:
    from reachy_companion.mcp_client import RemoteMcpToolClient
...
def _load_enabled_tools(tool_names: list[str], remote_tool_names: set[str]) -> List[type[Tool]]:
    ...
    for tool_name in tool_names:
        ...
        shared_module_path = f"reachy_companion.tools.{tool_name}"
        try:
